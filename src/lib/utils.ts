...
5. For each message in the table, use add-task tool to schedule sending the message at the corresponding time.
6. Make sure to take into account user's feedback on your daily proactive messages.
7. After changing task list, use list-tasks tool to confirm that all changes were applied properly.
`;
}